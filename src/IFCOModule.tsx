  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f5f3ee", fontFamily: "'Syne', sans-serif" }}>
      ...
      <div style={{ background: "#0a0a0a", borderBottom: "1px solid #222" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", boxSizing: "border-box", display: "flex", gap: 4, padding: "0 16px 8px" }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", boxSizing: "border-box", padding: "20px 16px 80px" }}>
